 ...
 */
function historiador_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Historiador default saturation level.
	 *
	 * @since Historiador 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'historiador_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.historiador-front-page) .entry-title,
...
.colors-custom .historiador-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.historiador-front-page .panel-content .recent-posts article,
...
.colors-custom.historiador-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Historiador custom colors CSS.
	 *
	 * @since Historiador 1.0
	 *
	 ...
	 */
	return apply_filters( 'historiador_custom_colors_css', $css, $hue, $saturation );
}
